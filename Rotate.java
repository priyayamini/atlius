...
class Rotate
{
    ...
    //In-place operations:all the operations are performed in place, no additional arrays are used
    //And the time complexity of this code is  O(n), where n is the size of the array
